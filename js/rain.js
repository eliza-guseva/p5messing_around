...
for (let i = 0; i < bright_drop_count; i++) {
    ...
    bright_drops.push(new Drop(Math.random() * window.innerWidth, Math.random() * window.innerHeight, gauss(75, 30), Math.max(1, gauss(2, 2)), Math.max(30, 50 + gauss(100, 50)), 0, [120 + color_gauss, 120 + color_gauss, 120 + color_gauss, 45 + gauss(5, 5)]));
}
var sketch = (p) => {
