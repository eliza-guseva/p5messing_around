...
function setupInitSquare(p) {
    let size = 50;
    let initX = getRandInt(size / 2, p.windowWidth - size / 2);
    let initY = getRandInt(size / 2, p.windowHeight - size / 2);
    let initSpeedX;
    let initSpeedY;
...
new p5(sketch);
//# sourceMappingURL=flying_cube.js.map